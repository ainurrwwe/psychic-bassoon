...
<head>
    ...
    <meta name="description" content="<?=$sitename?> - Все комиссии берем на себя, бонус при регистрации. Произведем выплаты за 24 часа на любую платежную систему.">
...
<link rel="stylesheet" href="/css/style.css?v=1575179594" id="layoutstyle">
...
<body class="page-user no-touch">
	...
	<div class="main-content col-12">
		<div class="content-area card">
			<div class="card-innr">
				<div class="content">
					<h4 class="text-secondary">Частые вопросы</h4>
					<div class="accordion-simple" id="faqList-1">
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-1"> Что такое <?=$sitename?>? </h6>
						...
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-3"> Как получить стартовый бонус? </h6>
							<div id="collapse-1-3" class="collapse" data-parent="#faqList-1">
								<div class="accordion-content">
									<p>Привяжите аккаунт Вконтакте и вступите в нашу группу. Стартовый бонус можно получить только 1 раз</p>
								</div>
							</div>
						</div>
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-2"> Какая у вас реферальная система? </h6>
						...
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-7"> Как пополнить? </h6>
							<div id="collapse-1-7" class="collapse" data-parent="#faqList-1">
								<div class="accordion-content">
									<p>Нажмите на кнопку "пополнить", укажите платежную систему, введите сумму</p>
								</div>
							</div>
						</div>
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-4"> Сколько времени занимает выплата? </h6>
							<div id="collapse-1-4" class="collapse" data-parent="#faqList-1">
								<div class="accordion-content">
									<p>Процесс выплаты занимает от 5 минут до 24 часов с момента создания заявки</p>
								</div>
							</div>
						</div>
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-5"> Как отменить выплату? </h6>
						...
						<div class="accordion-item">
							<h6 class="accordion-heading collapsed" data-toggle="collapse" data-target="#collapse-1-6"> Ввели неправильные реквизиты? </h6>
