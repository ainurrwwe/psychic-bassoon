  ...
  margin: 0 16px;
    ...
    background-size: 100% 100%;
                        ...
                        <ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#newdouble" style="display:none">x50</a></li>
                        </ul>
        ...
        <div class="modal-content"><a class="modal-close" data-dismiss="modal" aria-label="Close"><em class="ti ti-close"></em></a>
            <div class="popup-body">
                ...
                <ul class="pay-list guttar-15px">
                    ...
                    <li class="pay-item" onclick="$('#systemPay').val('1')"><input type="radio" class="pay-check" name="pay-option" id="pay-paypal"><label class="pay-check-label" style='height:65px' for="pay-paypal"><img src="../images/mk.png" alt="pay-logo" style="width:100%;height: 40px;margin: 10px;"></label></li>
                       <!--
